        ...
        <div class="col-md-3 mb-3">
            <div class="card stats-card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-1">Joyas</h6>
                            <h3 class="mb-0"><?= $stats['total_joyas'] ?></h3>
                        </div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card stats-card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-1">Cerámicas</h6>
                            <h3 class="mb-0"><?= $stats['total_ceramicas'] ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0">$<?= number_format($stats['precio_promedio'], 0, ',', '.') ?></h3>
                        </div>
